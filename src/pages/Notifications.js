...
const Notifications = () => {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 4, title: "Health Tip", message: "Stay hydrated today for better wellness.", unread: true },
    { id: 5, title: "Health Tip", message: "Stay hydrated today for better wellness.", unread: false },
    { id: 6, title: "Health Tip", message: "Stay hydrated today for better wellness.", unread: true },
    { id: 7, title: "Health Tip", message: "Stay hydrated today for better wellness.", unread: false },
    { id: 8, title: "Health Tip", message: "Stay hydrated today for better wellness.", unread: true },
